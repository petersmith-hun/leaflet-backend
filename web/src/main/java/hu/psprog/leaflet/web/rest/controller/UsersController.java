...
public class UsersController extends BaseController {
    ...
    public ModelAndView getUserByID(@PathVariable(PATH_VARIABLE_USER_ID) Long id) throws ResourceNotFoundException {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ModelAndView updateRole(@PathVariable(PATH_VARIABLE_USER_ID) Long id,
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ModelAndView updateProfile(@PathVariable(PATH_VARIABLE_USER_ID) Long id,
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ModelAndView updatePassword(@PathVariable(PATH_VARIABLE_USER_ID) Long id,
