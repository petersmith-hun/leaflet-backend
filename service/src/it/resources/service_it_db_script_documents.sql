...
insert into leaflet_documents
    (id, date_created, is_enabled, date_last_modified, content, raw_content, link, locale, seo_description, seo_keywords, seo_title, title, user_id)
values
    (1, @DEFAULT_DATE, true, @DEFAULT_DATE, @ENTRY_CONTENT_1, @ENTRY_RAW_CONTENT_1, @ENTRY_LINK_1, @DEFAULT_LOCALE, @ENTRY_TITLE_1, @ENTRY_TITLE_1, @ENTRY_TITLE_1, @ENTRY_TITLE_1, @USER_ID),
    (2, @DEFAULT_DATE, true, @DEFAULT_DATE, @ENTRY_CONTENT_2, @ENTRY_RAW_CONTENT_2, @ENTRY_LINK_2, @DEFAULT_LOCALE, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @USER_ID),
    (3, @DEFAULT_DATE, false, @DEFAULT_DATE, @ENTRY_CONTENT_3, @ENTRY_RAW_CONTENT_3, @ENTRY_LINK_3, @DEFAULT_LOCALE, @ENTRY_TITLE_3, @ENTRY_TITLE_3, @ENTRY_TITLE_3, @ENTRY_TITLE_3, @USER_ID),
    (4, @DEFAULT_DATE, true, @DEFAULT_DATE, @ENTRY_CONTENT_3, @ENTRY_RAW_CONTENT_3, @ENTRY_LINK_4, @DEFAULT_LOCALE, @ENTRY_TITLE_4, @ENTRY_TITLE_4, @ENTRY_TITLE_4, @ENTRY_TITLE_4, @USER_ID);