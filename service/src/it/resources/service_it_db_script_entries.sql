...
values
    ...
    (2, @DEFAULT_DATE, true, @DEFAULT_DATE, @ENTRY_CONTENT_2, @ENTRY_LINK_2, @DEFAULT_LOCALE, @COMMON_PROLOGUE, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @ENTRY_TITLE_2, @CATEGORY_ID, @USER_ID, @STATUS_REVIEW),
