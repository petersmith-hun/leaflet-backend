...
values
    ...
    (10, @DEFAULT_DATE, true, @DEFAULT_DATE, 'Route 10', 'route-10', '/route/dynamic/entry-pattern-1', 10, 'ENTRY_ROUTE_MASK'),
    (11, @DEFAULT_DATE, true, @DEFAULT_DATE, 'Route 11', 'route-11', '/route/dynamic/category', 11, 'CATEGORY_ROUTE_MASK'),
    (12, @DEFAULT_DATE, true, @DEFAULT_DATE, 'Route 12', 'route-12', '/route/dynamic/entry-pattern-2', 12, 'ENTRY_ROUTE_MASK'),
    (13, @DEFAULT_DATE, false, @DEFAULT_DATE, 'Route 13', 'route-13', '/route/dynamic/entry-pattern-3', 13, 'ENTRY_ROUTE_MASK');