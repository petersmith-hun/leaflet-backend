...
/**
 * Unit tests for {@link CommentByDeletedFlagSearchStrategy}.
 *
 * @author Peter Smith
 */
@ExtendWith(MockitoExtension.class)
class CommentByDeletedFlagSearchStrategyTest {
    ...
    @InjectMocks
    private CommentByDeletedFlagSearchStrategy strategy;
    ...
    public void shouldGetSpecificationReturnIsEnabledSpecificationForTrueEnabledFlagInRequest() {
        ...
        given(root.get(Comment_.deleted)).willReturn(path);
    ...
    private CommentSearchParametersVO prepareCommentSearchParametersVO(Boolean deletedFlag) {

        return CommentSearchParametersVO.builder()
                .deleted(Optional.ofNullable(deletedFlag))
                .build();
    }
}
